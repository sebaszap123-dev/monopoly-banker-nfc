...
class ReadCardNfcV2 extends StatefulWidget {
  const ReadCardNfcV2({Key? key, this.customText}) : super(key: key);
  final String? customText;

  @override
  State<ReadCardNfcV2> createState() => _ReadCardNfcV2State();
}

class _ReadCardNfcV2State extends State<ReadCardNfcV2> {
  MonopolyCardV2? cardPlayer;
  bool hasError = false;
  String error = '';
  bool hasData = false;
        ...
        if (tag.data.containsKey('ndef')) {
          ...
          if (ndef != null) {
            ...
            if (cachedMessage != null) {
              final resp = MonopolyCardV2.fromNdefMessage(cachedMessage);
              setState(() {
                cardPlayer = resp;
                hasData = true;
              });
