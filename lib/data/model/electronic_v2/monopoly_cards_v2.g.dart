...
part of 'monopoly_cards_v2.dart';
...
const MonopolyCardV2Schema = Schema(
  name: r'MonopolyCardV2',
  id: 8572728039316567072,
  properties: {
  ...
  estimateSize: _monopolyCardV2EstimateSize,
  serialize: _monopolyCardV2Serialize,
  deserialize: _monopolyCardV2Deserialize,
  deserializeProp: _monopolyCardV2DeserializeProp,
);

int _monopolyCardV2EstimateSize(
  MonopolyCardV2 object,
  List<int> offsets,
...
P _monopolyCardV2DeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension MonopolyCardV2QueryFilter
    on QueryBuilder<MonopolyCardV2, MonopolyCardV2, QFilterCondition> {
...
extension MonopolyCardV2QueryObject
    on QueryBuilder<MonopolyCardV2, MonopolyCardV2, QFilterCondition> {}
